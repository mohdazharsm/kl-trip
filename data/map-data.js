...
window.MAP_DATA = {
  map_d1: {
    ...
    googleMapsUrl: "https://www.google.com/maps/dir/120+Jalan+Pudu+Kuala+Lumpur/KLCC+Park+KL/Petronas+Twin+Towers+KL/Jalan+Alor+Bukit+Bintang+KL/120+Jalan+Pudu+Kuala+Lumpur",
    chipStops: [
      { num: "H", isHotel: true, name: "My Hotel Jalan Pudu" },
      { num: "1", name: "KLCC Park", km: "1.6 km" },
      { num: "2", name: "Petronas Towers ✅", km: "0.1 km" },
      { num: "3", name: "KLCC Fountain Show", km: "0.1 km" },
      { num: "4", name: "Jalan Alor", km: "1.4 km" },
      { num: "H", isHotel: true, name: "My Hotel", km: "0.2 km" }
    ],
    stops: [
      [3.14451, 101.70627, 'H', 'My Hotel @ Jalan Pudu', true],
      [3.15574, 101.71500, '1', 'KLCC Park', false],
      [3.15780, 101.71170, '2', 'Petronas Twin Towers ✅ Booked 4:30 PM', false],
  ...
  map_d2: {
    ...
    googleMapsUrl: "https://www.google.com/maps/dir/120+Jalan+Pudu+KL/KL+Forest+Eco+Park/Masjid+Wilayah+Persekutuan+KL/Brickfields+KL/Thean+Hou+Temple+KL/Petaling+Street+KL/Pavilion+KL/120+Jalan+Pudu+KL",
    chipStops: [
      { num: "H", isHotel: true, name: "My Hotel Jalan Pudu" },
      { num: "1", name: "Forest Eco Park", km: "1.0 km" },
      ...
      { num: "6", name: "Pavilion KL", km: "2.0 km" },
      { num: "H", isHotel: true, name: "My Hotel", km: "0.3 km" }
    ],
    stops: [
      [3.14451, 101.70627, 'H', 'My Hotel @ Jalan Pudu', true],
  ...
  map_d3: {
    ...
    googleMapsUrl: "https://www.google.com/maps/dir/120+Jalan+Pudu+KL/Batu+Caves+Selangor/Zoo+Negara+Malaysia/120+Jalan+Pudu+KL",
    chipStops: [
    ...
    stops: [
      [3.14451, 101.70627, 'H', 'My Hotel — Leave 6:45 AM', true],
      [3.23790, 101.68410, '1', 'Batu Caves (7:30–11:30 AM)', false],
      [3.21090, 101.75630, '2', 'Zoo Negara (12–4 PM)', false],
      [3.14451, 101.70627, 'H', 'My Hotel — Back ~4:30 PM', true]
    ]
  },
  map_d4: {
    title: "Day 4 Route — Genting + Aquaria",
    googleMapsUrl: "https://www.google.com/maps/dir/120+Jalan+Pudu+KL/Awana+SkyWay+Genting/Chin+Swee+Caves+Temple/SkyAvenue+Genting/Aquaria+KLCC+KL/120+Jalan+Pudu+KL",
    chipStops: [
      { num: "H", isHotel: true, name: "My Hotel Jalan Pudu" },
      ...
      { num: "H", isHotel: true, name: "My Hotel", km: "1.2 km" }
    ],
    stops: [
      [3.14451, 101.70627, 'H', 'My Hotel @ Jalan Pudu', true],
  ...
  map_d5: {
    ...
    googleMapsUrl: "https://www.google.com/maps/dir/120+Jalan+Pudu+KL/Pavilion+Kuala+Lumpur/KL+Sentral/KLIA+Airport+Malaysia",
    chipStops: [
      { num: "H", isHotel: true, name: "My Hotel Jalan Pudu" },
      { num: "1", name: "Pavilion KL", km: "1.0 km" },
